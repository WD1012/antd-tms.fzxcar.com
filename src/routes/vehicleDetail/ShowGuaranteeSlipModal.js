...
const modal = ({
  ...
  const fileList = guaranteeSlipFileList.fileList?guaranteeSlipFileList.fileList:[]
  ...
  return (
    <Modal {...modalOpts}>
      <Form layout="horizontal">
        ...
        <FormItem label="保单" hasFeedback {...formItemLayout}>
...
modal.propTypes = {
  ...
  guaranteeSlipFileList:PropTypes.object,
