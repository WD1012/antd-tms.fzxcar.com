    ...
    return {
      click: (e) => {
        ...
        geocoder.getLocation(e.point,function(rs){
          ...
          address = rs.address
          console.log('map click event', e.point);
  ...
  return (
    <Modal {...modalOpts}>
      <Form layout="horizontal">
        ...
        <Row gutter={24}>
          <Map events={getEvents()} enableScrollWheelZoom center={center===''?'北京市东城区':center} zoom={15} >
            {markerVisible &&
            <Marker position={{lng: lon===0?116.403856:lon, lat: lat===0?39.913978:lat}} >
